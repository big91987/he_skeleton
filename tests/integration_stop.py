...
context={'source':str(source),'workspace':str(work),'session':str(root),'evidence':str(evidence),'stage':'implementation','task':{'number':1},'config':cfg,'controls':controls(work),'deadline_monotonic':time.monotonic()+360}
