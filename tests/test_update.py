...
from update_project import MANAGED, prepare
...
class UpdateProject(unittest.TestCase):
    def test_pinned_sync_preserves_business_and_rejects_drift(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            self.assertEqual(set(changes),set(MANAGED)|{'harness-upstream.json'})
            ...
            with self.assertRaisesRegex(ValueError,'Product modified'):
